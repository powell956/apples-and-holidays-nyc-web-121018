...
def all_supplies_in_holidays(holiday_hash)
  ...
  holiday_hash.each do |season, holidays|
    ...
    holidays.each do |holiday, supplies_list|
      ...
      formatted_holiday = "  " + holiday_words.join(" ")

      supplies_string = ""
      supplies_list.each_with_index do |item, index|
        if index == supplies_list.length - 1
          supplies_string = supplies_string + item
        else
          supplies_string = supplies_string + item + ", "
        end
      end
      puts formatted_holiday + ": " + supplies_string
    end
  end
end
